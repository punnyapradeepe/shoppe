...
export default function PasswordScreen() {
  ...
  return (
    ...
    <View style={{alignItems:'center',position:'absolute',top:'20%',left:'20%'}}>
<View  style={{position:'relative'}}>
      <Image
      ...
      <Image
      source={require('./../../assets/Images/artist-2 1 (1).png')} style={{borderRadius:99,}}
      />
      </View>
      ...
      <View style={styles.container}>
       ...
       <TouchableOpacity onPress={() => navigation.navigate('forgot')}>
        ...
        <TouchableOpacity>
          <Text style={{marginTop:70,marginLeft:'30%'}}>Continue</Text>
        </TouchableOpacity>
       </View>
